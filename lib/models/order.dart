...
class Order{
  ...
  List<Item> itemList = <Item>[];//liste littérale = liste dont la taille n'est pas renseigné (d'apres la documentation officiel de dart )
  ...
  Order.kitchen(this.customer, this.containDrink, this.containFood, this._id, this.totalPrice,this.date);
  Order.television(this.customer,this.containDrink,this.containFood,this.date,this.finish,this.isOnScreen);
  Order.statistic(this.customer,this.totalPrice,this.sellerId,this.date,this.itemUsed);
